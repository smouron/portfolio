...
<body>
    ...
    <main>		
		<section class="development">
			<h1>Les différentes réalisations que j'ai effectuées avec OpenClassrooms</h1>
			<div id="liste-achievements" class="directionRow">
				<?php foreach ($achievements as $realization): ?> 
					<?php if($realization['origine'] == "OpenClassrooms" || $realization['origine'] == "openclassrooms"): ?>
