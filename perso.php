...
<body>
    ...
    <main>		
		<section class="development">
			<h1>Les différentes réalisations personnelles que j'ai effectuées</h1>
			<div id="liste-achievements" class="directionRow">
				<?php foreach ($achievements as $realization): ?> 
					<?php if($realization['origine'] == "Stéphane Mouron" || $realization['origine'] == "Stephane Mouron" || $realization['origine'] == "stephane mouron"): ?>
